...
def get_log_message(count_dir,count_image_file,base_time_0,base_time_n):
    ...
    elapsed_time_n = kstd.get_elapsed_time(base_time_n)
    elapsed_time_n_m = int(elapsed_time_n)
    time_bet_n = "{0:04d}".format(elapsed_time_n_m)

    elapsed_time_0 = kstd.get_elapsed_time(base_time_0)
    elapsed_time_0_m = int(elapsed_time_0)
    time_bet_0 = "{0:04d}".format(elapsed_time_0_m)
    ...
    message = message + "\t(" + time_bet_n + " / " + time_bet_0 + " m)"
    return message
